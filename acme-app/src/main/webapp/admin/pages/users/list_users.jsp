            ...
            <div class="table table-responsive table-striped table-hover">
                        	...
                        	<tr>
                        		...
                        		<td>
                        			<a class="btn btn-warning" 
                        				href="${pageContext.request.contextPath}/userServlet?id=${users.id}&acao=editar">
                        					<c:out value="Editar"/>
                        			</a>
                        		</td>
                        		...
                        		<td>
                        			<a class="btn btn-danger" 
                        				href="${pageContext.request.contextPath}/userServlet?id=${users.id}&acao=remover">
                        					<c:out value="Remover"/>
                        			</a>
                        		</td>
                        	</tr>
                    ...
                    <div align="center">
						<a class="btn btn-info" 
							href="${pageContext.request.contextPath}/userServlet?&acao=cadastrar">
